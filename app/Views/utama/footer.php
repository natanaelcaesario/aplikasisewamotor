...
<script src="<?= base_url('admintemplate/vendor/chart.js/Chart.min.js') ?>"></script>

<!-- Page level custom scripts -->

<script src="<?= base_url('admintemplate/js/demo/chart-area-demo.js') ?>"></script>
<script src="<?= base_url('admintemplate/js/demo/chart-pie-demo.js') ?>"></script>
